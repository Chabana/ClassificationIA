...
def isTestPos(name):
    return isInTab(name, TabPos)

def isTestNeg(name):
    return isInTab(name, TabNeg)

def isTrainPos(name):
    return not isInTab(name, TabPos)

def isTrainNeg(name):
    return not isInTab(name, TabNeg)

def isInTab(name, tab):
...
if __name__ == "__main__":
    print(createRandom(1000, 0.2))
    print(createRandom(1000, 0.2))

    print(isTestPos("pos-0003.txt"))
    print(isTestPos("pos-0007.txt"))
    print(isTrainPos("pos-0003.txt"))
    print(isTrainPos("pos-0007.txt"))